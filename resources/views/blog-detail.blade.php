...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <a class="home" href="{{Asset('')}}blog.html" title="Blog">Tin Tức</a>
            <span class="navigation-pipe">&nbsp;</span>
        ...
        <div class="row">
            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
                ...
                <div class="block left-module">
                    <p class="title_block">Chủ Đề</p>
                    <div class="block_content">
                        <!-- layered -->
                        <div class="layered layered-category">
                            <div class="layered-content">
                                <ul class="tree-menu">
                                    @for($i=0;$i< count($chude);$i++)
                                    <li><span></span><a href="{{$detailp->unicode_str_filter($chude[$i]->name)}}">{{$chude[$i]->name}}</a></li>
                                    @endfor
                                </ul>
                            </div>
                        </div>
                                   ...
                                   @for($i=0;$i< count($noibat);$i++)
                                        <li>
                                            <div class="post-thumb">
                                                <a href="#"><img src="public/assets/data/{{$noibat[$i]->img}}" alt="Blog"></a>
                                            </div>
                                            <div class="post-info">
                                                <h5 class="entry_title"><a href="{{$detailp->unicode_str_filter($noibat[$i]->name)}}-b{{$noibat[$i]->id}}.html">{{$noibat[$i]->name}}</a></h5>
                                                <div class="post-meta">
                                                    <span class="date"><i class="fa fa-calendar"></i>{{$noibat[$i]->datepost}}</span>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <article class="entry-detail">
                    <div class="entry-meta-data">
                        ...
                        by: <a href="#">{{$detail[0]->userpost}}</a></span>
                        ...
                        <span class="date"><i class="fa fa-calendar"></i>{{$detail[0]->datepost}}</span>
                        <span style='display:none' class="post-star">
                    ...
                    <div class="entry-photo">
                        <img src="public/assets/data/{{$detail[0]->img}}" alt="Blog">
                    </div>
                ...
                <div class="single-box">
                    ...
                    <ul class="related-posts owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":2},"1000":{"items":3}}'>
                        ...
                        @if($splienquan[$i]->id != $detail[0]->id)
                        <li class="post-item">
                            <article class="entry">
                                <div class="entry-thumb image-hover2">
                                    <a href="{{$detailp->unicode_str_filter($splienquan[$i]->name)}}-b{{$splienquan[$i]->id}}.html">
                                        <img src="public/assets/data/{{$splienquan[$i]->img}}" alt="Blog">
                                    </a>
                                </div>
                                <div class="entry-ci">
                                    <h3 class="entry-title"><a href="{{$detailp->unicode_str_filter($splienquan[$i]->name)}}-b{{$splienquan[$i]->id}}.html">{{$splienquan[$i]->name}}</a></h3>
                                    <div class="entry-meta-data">
                                       <!--  <span class="comment-count">
                                            <i class="fa fa-comment-o"></i> 3
                                        </span> -->
                                        <span class="date">
                                            <i class="fa fa-calendar"></i> {{$splienquan[$i]->datepost}}
                                        </span>
                                    </div>
                                    <div class="entry-more">
                                        <a href="{{$detailp->unicode_str_filter($splienquan[$i]->name)}}-b{{$splienquan[$i]->id}}.html">Read more</a>
                                    </div>
                                </div>
                            </article>
                        </li>
                ...
                <div class="single-box">
                    ...
                    <div class="comment-list">
                       <div class="fb-comments" data-href="{{Asset('')}}{{$detailp->unicode_str_filter($detail[0]->name)}}-b{{$detail[0]->id}}.html" data-numposts="5"></div>
                    </div>
                </div>
