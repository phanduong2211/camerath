...
<!--     <link rel="stylesheet" type="text/css" href="public/assets/css/animate.css" />
    ...
    <title>{{$detail[0]->tenphukien}}</title>
    <style type="text/css">
...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <a href="" title="Return to Home">Phụ Kiện</a>
            <span class="navigation-pipe">&nbsp;</span>
            <a href="" title="Return to Home"><?php foreach ($danhmuc as $vars) {
                                        if($vars->id_danhmucphukien==$detail[0]->id_danhmucphukien)
                                            echo $vars->tendanhmuc;
                                    } ?></a>
            <span class="navigation-pipe">&nbsp;</span>
            <a href="" title="Return to Home">{{$detail[0]->tenphukien}}</a>
                                ...
                                <li>
                                    ...
                                    <div class="products-block-right">
                                        <p class="product-name">
                                            <a href="{{$detailp->unicode_str_filter($splienquan[$i]->tenphukien)}}-p{{$splienquan[$i]->id_phukiensanpham}}.html">{{$splienquan[$i]->tenphukien}}</a>
                                        </p>
                    ...
                    <div id="product">
                        <div class="primary-box row">
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-6">
                                <h1 class="product-name">{{$detail[0]->tenphukien}}</h1>
                                ...
                                <div class="info-orther">
                                    <p>Mã Sản Phẩm: #c0{{$detail[0]->id_phukiensanpham}}</p>
                            ...
                            @for($i=0;$i< count($splienquan);$i++)
                                <li>
                                    <div class="product-container">
                                        ...
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="#">{{$splienquan[$i]->tenphukien}}</a></h5>
                                            <div class="product-star">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
