                    ...
                    <div class="block_content">
                            ...
                            <li>
                                ...
                                <div class="products-block-right">
                                    ...
                                    <p class="product-name">
                                        <a href="{{$detailp->unicode_str_filter($c_camera[0]->tensanpham)}}-c{{$c_camera[0]->id_sanpham}}.html">{{$c_camera[0]->tensanpham}}</a>
                                    </p>
                        ...
                        <div class="products-block">
                            <div class="products-block-bottom">
                                <a class="link-all" href="{{$detailp->unicode_str_filter($c_camera[0]->tensanpham)}}-c{{$c_camera[0]->id_sanpham}}.html">Chi Tiết</a>
                            </div>
                        </div>
