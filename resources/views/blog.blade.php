                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="entry-thumb image-hover2">
                                        <a href="{{$detailp->unicode_str_filter($blog[$i]->name)}}-b{{$blog[$i]->id}}.html">
                                            <img src="public/assets/data/{{$blog[$i]->img}}" alt="Blog">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="entry-ci">
                                        <h3 class="entry-title"><a href="{{$detailp->unicode_str_filter($blog[$i]->name)}}-b{{$blog[$i]->id}}.html">{{$blog[$i]->name}}</a></h3>
                                        <div class="entry-meta-data">
                                            <span class="author">
                                            <i class="fa fa-user"></i> 
                                            by: <a href="#">{{$blog[$i]->userpost}}</a></span>
                                            ...
                                            <span class="date"><i class="fa fa-calendar"></i> {{$blog[$i]->datepost}}</span>
                                        </div>
                                        ...
                                        <div class="entry-excerpt">
                                           <?php echo substr($blog[$i]->contents,0,300) ?> ...   
                                        </div>
                                        <div class="entry-more">
                                            <a href="{{$detailp->unicode_str_filter($blog[$i]->name)}}-b{{$blog[$i]->id}}.html">Read more</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
