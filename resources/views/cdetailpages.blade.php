...
<!--     <link rel="stylesheet" type="text/css" href="public/assets/css/animate.css" />
    ...
    <title>{{$detail[0]->tensanpham}}</title>
    <style type="text/css">
...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <a href="" title="Return to Home">Camera</a>
            <span class="navigation-pipe">&nbsp;</span>
            ...
            <span class="navigation-pipe">&nbsp;</span>
            <a href="" title="Return to Home">{{$detail[0]->tensanpham}}</a>
                                ...
                                <li>
                                    ...
                                    <div class="products-block-right">
                                        <p class="product-name">
                                            <a href="{{$detailp->unicode_str_filter($splienquan[$i]->tensanpham)}}-c{{$splienquan[$i]->id_sanpham}}.html">{{$splienquan[$i]->tensanpham}}</a>
                                        </p>
                    ...
                    <div id="product">
                        <div class="primary-box row">
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-6">
                                <h1 class="product-name">{{$detail[0]->tensanpham}}</h1>
                                ...
                                <div class="info-orther">
                                    <p>Mã Sản Phẩm: #c0{{$detail[0]->id_sanpham}}</p>
                            ...
                            @for($i=0;$i< count($splienquan);$i++)
                                <li>
                                    <div class="product-container">
                                        ...
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="{{$detailp->unicode_str_filter($splienquan[$i]->tensanpham)}}-c{{$splienquan[$i]->id_sanpham}}.html">{{$splienquan[$i]->tensanpham}}</a></h5>
                                            <div class="product-star">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                            ...
                            <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":3}}'>
                                ...
                                <li>
                                    <div class="product-container">
                                        ...
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="{{$detailp->unicode_str_filter($spmuonxem[$i]->tendaughi)}}-d{{$spmuonxem[$i]->id_daughisanpham}}.html">{{$spmuonxem[$i]->tendaughi}}</a></h5>
                                            <div class="product-star">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
