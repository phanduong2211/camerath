                    ...
                    <div class="block_content">
                            ...
                            <li>
                                ...
                                <div class="products-block-right">
                                    ...
                                    <p class="product-name">
                                        <a href="{{$detailp->unicode_str_filter($c_camera[0]->tendaughi)}}-d{{$c_camera[0]->id_daughisanpham}}.html">{{$c_camera[0]->tendaughi}}</a>
                                    </p>
                        ...
                        <div class="products-block">
                            <div class="products-block-bottom">
                                <a class="link-all" href="{{$detailp->unicode_str_filter($c_camera[0]->tendaughi)}}-d{{$c_camera[0]->id_daughisanpham}}.html">Chi Tiết</a>
                            </div>
                        </div>
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                ...
                                <div class="right-block">
                                    <h5 class="product-name"><a href="{{$detailp->unicode_str_filter($c_camera[$i]->tendaughi)}}-d{{$c_camera[$i]->id_daughisanpham}}.html">{{$c_camera[$i]->tendaughi}}</a></h5>
                                    ...
                                    <div class="info-orther">
                                        <p>Mã sản phẩm: #c0{{$c_camera[$i]->id_daughisanpham}}</p>
