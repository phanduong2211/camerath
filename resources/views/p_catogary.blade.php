                    ...
                    <div class="block_content">
                            ...
                            <li>
                                ...
                                <div class="products-block-right">
                                    ...
                                    <p class="product-name">
                                        <a href="{{$detailp->unicode_str_filter($c_camera[0]->tenphukien)}}-p{{$c_camera[0]->id_phukiensanpham}}.html">{{$c_camera[0]->tenphukien}}</a>
                                    </p>
                        ...
                        <div class="products-block">
                            <div class="products-block-bottom">
                                <a class="link-all" href="{{$detailp->unicode_str_filter($c_camera[0]->tenphukien)}}-p{{$c_camera[0]->id_phukiensanpham}}.html">Chi Tiết</a>
                            </div>
                        </div>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                ...
                                <div class="right-block">
                                    <h5 class="product-name"><a href="{{$detailp->unicode_str_filter($c_camera[$i]->tenphukien)}}-p{{$c_camera[$i]->id_phukiensanpham}}.html">{{$c_camera[$i]->tenphukien}}</a></h5>
                                    ...
                                    <div class="info-orther">
                                        <p>Mã sản phẩm: #c0{{$c_camera[$i]->id_phukiensanpham}}</p>
                ...
                <div class="sortPagiBar">
                    <div class="bottom-pagination">
                        <nav>
                          <ul class="pagination">
                            @for($i=1;$i< ((count($c_camera))/12)+1;$i++)
                                @if($i==1)
