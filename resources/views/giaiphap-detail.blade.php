...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <a class="home" href="{{Asset('')}}blog.html" title="Blog">Giải Pháp</a>
            <span class="navigation-pipe">&nbsp;</span>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <article class="entry-detail">
                    ...
                    <div class="entry-photo">
                        <img src="public/assets/data/{{$detail[0]->hinhanh}}" alt="Blog">
                    </div>
                        ...
                        <li class="post-item">
                            <article class="entry">
                                <div class="entry-thumb image-hover2">
                                    <a href="{{$detailp->unicode_str_filter($splienquan[$i]->name)}}-g{{$splienquan[$i]->id}}.html">
                                        <img src="public/assets/data/{{$splienquan[$i]->hinhanh}}" alt="Blog">
                                    </a>
                                </div>
                                <div class="entry-ci">
                                    <h3 class="entry-title"><a href="{{$detailp->unicode_str_filter($splienquan[$i]->name)}}-g{{$splienquan[$i]->id}}.html">{{$splienquan[$i]->name}}</a></h3>
                                    ...
                                    <div class="entry-more">
                                        <a href="{{$detailp->unicode_str_filter($splienquan[$i]->name)}}-g{{$splienquan[$i]->id}}.html">Read more</a>
                                    </div>
                                </div>
                            </article>
                        </li>
                ...
                <div class="single-box">
                    ...
                    <div class="comment-list">
                       <div class="fb-comments" data-href="{{Asset('')}}{{$detailp->unicode_str_filter($detail[0]->name)}}-g{{$detail[0]->id}}.html" data-numposts="5"></div>
                    </div>
                </div>
